...
//        presetCoreData()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let imageItem = imageItemArray[indexPath.row]
        cell.img_ImageView.image = UIImage(named:imageItem.imageName!)
        cell.lbl_Name.text = imageItem.imageName
        cell.lbl_By.text = imageItem.imageBy
        cell.lbl_Year.text =  imageItem.imageYear
        return cell
    }
